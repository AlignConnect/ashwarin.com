  ...
  return (
    <section>
      <div className="m-2 md:m-5 rounded-xl">
        <form onSubmit={handleFormSubmit}>
          <div className="bg-[#ececec]">
            <h2 className="text-center py-3 font-bold text-2xl">
              Shipping Details
            </h2>
            {inputDataValue?.map((ele, key) => {
              return (
                <div key={key} className="w-full px-3 mx-auto py-2">
                  <div>{ele.label}</div>
                  <div className="flex items-center border p-2 rounded-[50px] bg-white">
                    ...
                    <div className="w-full">
                      <input
                        ...
                        value={chng[ele.inputValue.name]}
                      />
                    </div>
                  </div>
                </div>
          ...
          <div className="border border-xl border-[green] rounded-md p-2">
            ...
            <div className="flex justify-between p-3">
              ...
              <h2 className="text-green-600 font-bold text-xl">
                Rs.{ActiveProduct?.price - ActiveProduct?.discount}
              </h2>
            </div>
            ...
            <section>
              <div
                className={`border p-2 my-2 ${
                  ...
                  "border-green-400 bg-green-100 rounded-md"
                }`}
              >
                <label
                ...
                >
                  <input
                    ...
                    id="onlinepayment"
                    onChange={() => {
                      setActiveProduct((ele) => ({
                        ...ele,
                        online: true,
                        discount: (ActiveProduct?.price * 10) / 100,
                      }));
                    }}
                  />
                  <Image
                    src={"/checkout_images/bank.png"}
                    width={250}
                    height={300}
                    alt="noim"
                  />
      ...
      <OrderModel
        ...
        setCashDelivery={setCashDelivery}
