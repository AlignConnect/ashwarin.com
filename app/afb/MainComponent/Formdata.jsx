...
const Formdata = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "ashwarin.com");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);

            formdata.append("blog_url", process.env.NEXT_APP_URL ?? "ashwarin.com");
            ...
            try {
                setLoading(true)
                const form = await fetch(`https://ashwarin.com/submitdata.php`, { body: formdata, method: "POST" })
